...
class KFilter {
  public:
    ...
    const cnoid::Vector2 &getx() { return x; }
    ...
    void resetStateByObservation() { x << z, 0; };

  private:
    cnoid::Matrix2 P, Q, I, F;
...
class RPYKalmanFilter {
  public:
    ...
    void setSensorR(const cnoid::Matrix3 &sr) { m_sensorR = sr; };
