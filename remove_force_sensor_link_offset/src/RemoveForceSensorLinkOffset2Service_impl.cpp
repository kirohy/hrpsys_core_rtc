...
CORBA::Boolean RemoveForceSensorLinkOffset2Service_impl::setForceMomentOffsetParam(
    const char *i_name_, const OpenHRP::RemoveForceSensorLinkOffset2Service::forcemomentOffsetParam &i_param_) {
    return m_rmfsoff->setForceMomentOffsetParam(std::string(i_name_), i_param_);
}

CORBA::Boolean RemoveForceSensorLinkOffset2Service_impl::getForceMomentOffsetParam(
    const char *i_name_, OpenHRP::RemoveForceSensorLinkOffset2Service::forcemomentOffsetParam_out i_param_) {
...
CORBA::Boolean RemoveForceSensorLinkOffset2Service_impl::removeForceSensorOffset(
    const ::OpenHRP::RemoveForceSensorLinkOffset2Service::StrSequence &names, CORBA::Double tm) {
    return m_rmfsoff->removeForceSensorOffset(names, tm);
}

void RemoveForceSensorLinkOffset2Service_impl::rmfsoff(RemoveForceSensorLinkOffset2 *i_rmfsoff) {
    m_rmfsoff = i_rmfsoff;
}
