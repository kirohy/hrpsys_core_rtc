...
void RobotHardware2Service_impl::initializeJointAngle(const char *name, const char *option) {
    m_robot->initializeJointAngle(name, option);
}

void RobotHardware2Service_impl::setServoGainPercentage(const char *jname, double percentage) {
    m_robot->setServoGainPercentage(jname, percentage, 0);
}

void RobotHardware2Service_impl::setServoPGainPercentage(const char *jname, double percentage) {
    m_robot->setServoGainPercentage(jname, percentage, 1);
}

void RobotHardware2Service_impl::setServoDGainPercentage(const char *jname, double percentage) {
    m_robot->setServoGainPercentage(jname, percentage, 2);
}
...
void RobotHardware2Service_impl::setServoErrorLimit(const char *jname, double limit) {
...
CORBA::Boolean RobotHardware2Service_impl::setJointInertia(const char *name, ::CORBA::Double mn) {
...
void RobotHardware2Service_impl::setDisturbanceObserverGain(::CORBA::Double gain) {
