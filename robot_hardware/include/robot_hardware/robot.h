...
class robot : public cnoid::Body {
  public:
    ...
    */
    ...
    int numAccSensors() { return acc_sensors_.size(); };
    int numGyroSensors() { return gyro_sensors_.size(); };
    int numForceSensors() { return force_sensors_.size(); };

    cnoid::AccelerationSensorPtr findAccSensor(int index) { return acc_sensors_[index]; }
    cnoid::RateGyroSensorPtr findGyroSensor(int index) { return gyro_sensors_[index]; }
    cnoid::ForceSensorPtr findForceSensor(int index) { return force_sensors_[index]; }
  ...
  private:
    ...
    std::vector<std::array<double, 3>> gyro_sum;
    std::vector<std::array<double, 3>> accel_sum;
    std::vector<std::array<double, 3>> att_sum;
    std::vector<std::array<double, 6>> force_sum;
    ...
    cnoid::DeviceList<cnoid::ForceSensor> force_sensors_;
    cnoid::DeviceList<cnoid::RateGyroSensor> gyro_sensors_;
    cnoid::DeviceList<cnoid::AccelerationSensor> acc_sensors_;
};
